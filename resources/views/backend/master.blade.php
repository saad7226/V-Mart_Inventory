...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <div class="wrapper">
        ...
        <!-- <div class="preloader flex-column justify-content-center align-items-center">
            <img class="animation__shake" src="{{ (readconfig('site_logo') ? assetImage(readconfig('site_logo')) : asset('assets/images/shopping-cart.png')) }}" alt="Logo" height="60"
                width="60">
        </div> -->
        ...
        <aside class="main-sidebar elevation-4 sidebar-light-primary">
            ...
            <a href="{{ route('frontend.home') }}" class="brand-link">
                <img src="{{ (readconfig('site_logo') ? assetImage(readconfig('site_logo')) : asset('assets/images/shopping-cart.png')) }}" alt="Logo"
