...
<body>
    ...
    <div class="auth-card">
        <div class="auth-header">
            <img src="{{ readconfig('site_logo') ? assetImage(readconfig('site_logo')) : asset('assets/images/shopping-cart.png') }}" alt="{{ readConfig('site_name') ?? 'V-Mart' }}" class="auth-logo" style="max-height:80px; width:auto;">
            <h1 class="auth-title">
