...
class DashboardController extends Controller
{
    public function index(Request $request)
    {
        ...
        $data = [
            ...
            'recent_sales' => Order::with('customer')->latest()->take(5)->get(),
        ];
        ...
        $dailyTotals = Order::selectRaw('DATE(created_at) as date, SUM(total) as total_amount')
        ...
        $salesData = Order::selectRaw('DATE_FORMAT(created_at, "%Y-%m") as month, SUM(total) as total_amount')
